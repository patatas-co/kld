...
<body>
    ...
    <section class="cta-section">
        <div class="cta-content" id="about">
            <h2>Why Choose Us?</h2>
            <p>Join thousands of students who have already discovered the power of connected learning. Start your journey today!</p>
            <a href="#join" class="cta-btn">Get Started Today</a>
        </div>
    </section>
    ...
    <footer>
        <div class="footer-content">
            ...
            <p>&copy; 2024 EduConnect. All rights reserved. Empowering education for a brighter future.</p>
        </div>
    </footer>
